...
namespace mcmtestOpenTK.Client.UIHandlers.Menus
{
    class MenuLabel: AbstractMenuItem
    {
        ...
        public MenuLabel(string _text, int X, int Y)
        {
            ...
            Text = new PieceOfText(_text, new Location(X, Y + 4, 0), FontSet.GetFont(GLFont.Standard.Name, GLFont.Standard.Size * 2));
        ...
        {
            Text.Position = new Location((int)RenderSquare.PositionLow.X, (int)RenderSquare.PositionLow.Y + 4, 0);
