...
namespace mcmtestOpenTK.Client.UIHandlers.Menus
{
    class MenuLabel: AbstractMenuItem
    {
        ...
        public MenuLabel(string _text, int X, int Y)
        {
            ...
            Text = new PieceOfText(_text, new Point(X, Y), FontSet.GetFont(GLFont.Standard.Name, GLFont.Standard.Size * 2));
        ...
        {
            Text.Position = new Point((int)RenderSquare.PositionLow.X, (int)RenderSquare.PositionLow.Y);
