...
namespace FMOD
{
    ...
    */
    ...
    {
        public const int    number = 0x00044201;
#if WIN64
    ...
    */
    ...
    {                       
        ...
        public int     maxVORBIScodecs;             /* [r/w] Optional. Specify 0 to ignore. For use with FMOD_CREATECOMPRESSEDSAMPLE only.  Vorbis codecs consume 12,000 bytes per instance and this number will determine how many Vorbis channels can be played simultaneously. Default = 32. */    
    ...
    */
    public class System
    {
        ...
        // MCMONKEY //
        public RESULT createSound(byte[] data, MODE mode, ref Sound sound)
        {
            RESULT result = RESULT.OK;
            IntPtr soundraw = new IntPtr();
            Sound soundnew = null;
            ...
            try
            {
                result = FMOD_System_CreateSound(systemraw, data, mode, 0, ref soundraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT createStream(byte[] data, MODE mode, ref Sound sound)
        {
            RESULT result = RESULT.OK;
            IntPtr soundraw = new IntPtr();
            Sound soundnew = null;
            ...
            try
            {
                result = FMOD_System_CreateStream(systemraw, data, mode, 0, ref soundraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
